        ...
        <div className="flex flex-wrap gap-y-12">
          ...
          <div className="w-full md:w-1/3 pr-8">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-startupia-purple/20 text-white/70 hover:text-startupia-purple transition-colors">
                <Twitter size={18} />
              </a>
              <a href="#" className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-startupia-purple/20 text-white/70 hover:text-startupia-purple transition-colors">
                <Linkedin size={18} />
              ...
              <a href="mailto:contact@startupia.fr" className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 hover:bg-startupia-purple/20 text-white/70 hover:text-startupia-purple transition-colors">
                <Mail size={18} />
              </a>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2">
                  <li>
                    <a href="#startup-index" className="text-white/60 hover:text-startupia-purple inline-flex items-center">
                      <ChevronRight size={14} className="mr-1" /> Startup Index
                    </a>
                  </li>
                  <li>
                    <a href="#startup-matcher" className="text-white/60 hover:text-startupia-purple inline-flex items-center">
                      <ChevronRight size={14} className="mr-1" /> Startup Matcher
                    </a>
                  </li>
                  <li>
                    <a href="#startup-cofounder" className="text-white/60 hover:text-startupia-purple inline-flex items-center">
                      <ChevronRight size={14} className="mr-1" /> Co-Founder
                    </a>
                  </li>
                  <li>
                    <a href="#" className="text-white/60 hover:text-startupia-purple inline-flex items-center">
