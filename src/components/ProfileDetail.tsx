...
const ProfileDetail = ({ profile, isOpen, onClose, onMatch }: ProfileDetailProps) => {
  ...
  const handleMatchRequest = () => {
    ...
    // Ouvrir la modale de demande de match au lieu d'appeler directement onMatch
  ...
  const handleMatchSuccess = () => {
    onMatch();
    // La modale se fermera elle-même après un envoi réussi
  };

  // ... keep existing code (component content with DialogContent, layout, badges, etc.)

  // Remplacer uniquement le bouton "Contacter" à la fin du JSX
  return (
    <>
      ...
      {/* Ajout de la modale de demande de match */}
      {profile && (
        <MatchRequestModal 
