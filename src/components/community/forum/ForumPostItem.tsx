      ...
      <div className="p-5">
        <div className="flex justify-between items-start mb-3">
          <div className="flex items-center gap-2 flex-wrap">
            ...
            {post.isPinned && <Badge className="bg-white/10 text-white font-medium py-1 px-2 rounded flex items-center gap-1 border border-white/20">
        ...
        <div className="flex justify-between items-center pt-3 border-t border-white/10 p-4 bg-startupia-turquoise">
          <div className="flex items-center text-sm">
            <Avatar className="h-8 w-8 mr-2 border border-white/20">
              {post.authorAvatar ? <AvatarImage src={post.authorAvatar} alt={post.authorName} /> : <AvatarFallback className="bg-startupia-turquoise/30 text-gray-950">{getInitials(post.authorName)}</AvatarFallback>}
            </Avatar>
