...
export const mockResources: ResourceListing[] = [
  {
    ...
    format: 'Vidéo',
    target_audience: "Professionnels, marketers, développeurs",
    access_link: "https://academy.startupia.fr/prompt-advanced",
    is_paid: true,
    price: "199€",
    author_id: uuidv4(),
  ...
  },
  {
    ...
    format: 'E-book',
    target_audience: "Développeurs, débutants en IA",
    access_link: "https://resources.startupia.fr/langchain-guide",
    is_paid: false,
    price: null,
    author_id: uuidv4(),
    author_name: "Maxime Dupont",
  ...
  },
  {
    ...
    format: 'Webinaire',
    target_audience: "Freelances, consultants, entrepreneurs",
    access_link: "https://events.startupia.fr/monetisation-ia",
    is_paid: false,
    price: null,
    author_id: uuidv4(),
    author_name: "Charlotte Girard",
